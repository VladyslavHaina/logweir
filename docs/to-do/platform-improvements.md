...
| PLAT-01.1, 01.2, 02.1, 02.2 | `artifacts/plat01-02-live/` and its result and review | **not yet re-proved**: re-run of `scripts/test-plat01-02-live.py` and `scripts/test-plat02-chart-live.py` is row (g) of lab-refresh-10 |
